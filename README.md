...
3. **Desarrollo de la API**: En esta fase, propusimos exponer los datos de la empresa mediante el uso del framework FastAPI. Creamos varios endpoints para la API, cada uno con su decorador correspondiente. Estas son las [funciones](https://github.com/JairAlarc/ProyectoCohorte16/blob/main/main.py)
...
Y por cierto se realizo un [Deployment](https://otro-657u.onrender.com/docs#/)https://otro-657u.onrender.com/docs#/) exitoso!
